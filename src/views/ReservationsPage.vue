<template>
  <div class="page" style="color: white;">
    ...
    <br>
    <div style="height: 400px; margin-bottom: 30px;" class="container" v-for="reservation in getReservation" :key="reservation.id">
      <div class="top-half">
      ...
      <div class="bottom-half">
        ...
        <div class="child2" style="color: black;">
          <div>
            ...
            <v-btn @click="cancelRes()" style="width: 170px; border-radius: 10px;">Отменить</v-btn>
          </div>
        </div>
